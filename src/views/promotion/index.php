        ...
        <div class="widget-content widget-content-area br-6">
          <div class="row">
            <div class="row col-md-12 col-xs-12">
              <form id="AnnounceForm" class="row col-md-12" method="post" action="<?=BASEURL;?>Promotion/index/">
                    ...
                    <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                        <div class="row">
                          ...
                          <div class="row text-center">
                            <form class="col-md-12" id="user_pagination" method="post" action="<?=BASEURL;?>Promotion/Index/">
     ...
     swal({
          ...
          padding: '2em'
            ...
            if (result.value) {
               ...
               $.post('<?= BASEURL ?>Promotion/Delete/',{getId:val},function(response){ 
