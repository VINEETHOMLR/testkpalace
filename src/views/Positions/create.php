            ...
            <div class="col-12">
                <div class="card">
                    <nav class="breadcrumb-two" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=BASEURL;?>Positions/Index/">Positions list</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Position</a></li>
                        </ol>
                    </nav>
                    <div class="card-body">
                        <div class="row" >
                                ...
                                <div class="step-1-user">
                                        ...
                                        <div class="col-md-8 col-sm-12 statbox widget box box-shadow">
                                            <div class="tabcontent col-sm-12 col-md-12">
                                                ...
                                                <div class="tabcontent form-group col-sm-12 col-md-12">
                                                    <select class="form-control custom-select dept" name="dept" id="dept">
                                    ...
                                    <div class="tabcontent panel-footer">
                                        <div class="form-actions text-center">
                                            <button type="button" class="btn btn-info proceedToNext col-12 col-md-3" onclick="save()">&nbsp;Save</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
function save()
{
    ...
    $.ajax({
              ...
              success: function(response){ 
                  ...
                  {
                      openSuccess(newResp['response'],'<?=BASEURL;?>Positions/Index/')  
                  }else
                  {
