                                ...
                                <thead>
                                  <tr role="row">
                                     <th class="sorting_disabled" rowspan="1" colspan="1" >RSVP Id</th>
                                      ...
                                      <th class="sorting_disabled" rowspan="1" colspan="1">Old Room No/Table No</th>
                                      <th class="sorting_disabled" rowspan="1" colspan="1">New Room No/Table No</th>
...
$(function () { 
    ...
    $('#changeHistoryMenu').addClass('active');
...
function exportReport(){
    ...
    $.post('<?=BASEURL?>Rsvp/ExportChangeHistory',{'user_id':customer_id,'from_booked_date':datefrom,'to_booked_date':dateto},
            function(response){
                hideoverlay();
        newResp = JSON.parse(response); 
        if(newResp['status'] == 'success')
...
function viewDetails(id)
{
     ...
     $('#viewModalbody').load('<?=BASEURL?>Rsvp/loadChangeDetails?id='+id);
