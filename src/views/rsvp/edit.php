                                    ...
                                    <div class="col-md-11 mt-4 mb-4 box1 rw1"  id="html_content"  >
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-3 form-group defaultTimeDiv" <?= $show_default_time_div ?>>
                                                ...
                                                <input id="from_time" name="from_time" type='text' class="form-control" type="time"  value="<?= $timeData['from_time']?>"> 
                                            ...
                                            <div class="col-12 col-md-3 form-group defaultTimeDiv" <?= $show_default_time_div ?>>
                                                ...
                                                <input id="to_time" name="to_time" type='text' class="form-control" type="time" value="<?= $timeData['to_time']?>"> 
...
var currentValue = document.getElementById('from_time').value;

flatpickr(document.getElementById('from_time'), {
    dateFormat: "h:i K",
    enableTime: true,
    noCalendar: true,
...
var currentValue2 = document.getElementById('to_time').value;

flatpickr(document.getElementById('to_time'), {
    dateFormat: "h:i K",
    enableTime: true,
    noCalendar: true,
...
function checkMerged()
{
    ...
    data.append('check_date_changed', true);
    data.append('booked_date', $('#booked_date').val());
    data.append('hour_id', $('#hour_id').val());
    data.append('checkin_time', $('#from_time').val());
    data.append('checkout_time', $('#to_time').val());
...
function changeTime(id)
{
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            flatpickr(document.getElementById('from_time'), {
                dateFormat: "h:i K", // Display only time with AM/PM
                enableTime: true,
                noCalendar: true, // Disable the calendar
                defaultDate: newResp['from_time'], // Set the default date/time
            });
            ...
            flatpickr(document.getElementById('to_time'), {
                ...
                enableTime: true,
                noCalendar: true, // Disable the calendar
                defaultDate: newResp['to_time'], // Set the default date/time
            });
