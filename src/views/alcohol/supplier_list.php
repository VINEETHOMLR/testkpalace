         ...
         <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="row">
                       <form id="btc_form" class="row col-md-12" method="post" action="<?=BASEURL;?>Alcohol/SupplierList/">
                        <div class="row col-md-12 col-xs-12">
                                 ...
                                 <!-- <div class="form-group col-sm-2">
                                  ...
                                  <div class="form-group col-sm-3">
                                    <input type="text" name="keyword" class="form-control select" id="keyword" placeholder="keyword">
                                  </div>
                    ...
                    <div class="table-responsive mb-4 mt-4" style="overflow-x: scroll !important;">
                        <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                          <div class="row">
                            <div class="col-sm-12">
                              <table id="dt" class="table table-hover dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="dt_info">
                                <thead>
                                  <th class="sorting_disabled" rowspan="1" colspan="1">Company Name</th>
                                  ...
                                  if(!empty($data['data'])){
                                   ...
                                   foreach($data['data'] as $key => $val){
                                    ...
                                    <tr role="row" class="odd">
                                      ...
                                      <td><?=!empty($val['email']) ? htmlspecialchars_decode($val['email']) : '-'?></td>
                                      <td><?=$val['action']?></td>
                          ...
                          <div class="row text-center">
                            <form class="col-md-12" id="deposit_pagination" method="post" action="<?=BASEURL;?>Alcohol/SupplierList/">
...
function pageHistory(name,status,page){
    $('.pagination').append('<input name="name" value="'+keyword+'" style="display:none;">');
