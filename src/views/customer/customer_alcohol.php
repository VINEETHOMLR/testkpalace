         ...
         <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="row">
                       <form id="btc_form" class="row col-md-12" method="post" action="<?=BASEURL;?>Customer/CustomerAlcoholList/">
                    ...
                    <div class="table-responsive mb-4 mt-4" style="overflow-x: scroll !important;">
                        <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                          ...
                          <div class="row text-center">
                            <form class="col-md-12" id="deposit_pagination" method="post" action="<?=BASEURL;?>Customer/CustomerAlcoholList/">
...
function pageHistory(userId,volume,alcohol,datefrom,dateto,page){
 ...
 $('#pageJump').val("<?=$data['curPage'];?>");
  ...
  function exportReport(){
        ...
        $.post('<?=BASEURL?>Customer/ExportCustomerAlcohol',{'user_id':userId,'alcohol':alcohol,'volume':volume,'datefrom':datefrom,'dateto':dateto},
            function(response){
                hideoverlay();
        newResp = JSON.parse(response);  
        if(newResp['status'] == 'success')
