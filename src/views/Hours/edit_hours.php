                ...
                <div class="card">
                    <nav class="breadcrumb-two" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?=BASEURL;?>Hours/Index/">List</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Edit Hours</a></li>
                                    ...
                                    <div class="panel-body row">
                                        <div class="col-md-8 col-sm-12 statbox widget box box-shadow">
                                            ...
                                            <div class="tabcontent form-group col-sm-12 col-md-12">
                                                <input type="text" id="name" name="name" class="form-control" placeholder="Enter Name" value ="<?=$details['name'];?>">
                                            </div>
                                           ...
                                           <div class=" content form-group col-sm-12 col-md-12">
                                                <input type="time" id="timepicker" name="from_time" class="form-control" placeholder="Enter From Time" value ="<?=$details['from_time'];?>">
                                            </div>
                                            ...
                                            <div class=" content form-group col-sm-12 col-md-12">
                                                <input type="time" id="timepicker" name="to_time" class="form-control" placeholder="Enter To Time" value ="<?=$details['to_time'];?>">
                                            </div>
...
$(function () {
    $('.proceedToNext').click(function(){
        postdata = $('#regiseterNewUser').serializeArray();
         ...
         $.post('<?=BASEURL;?>Hours/UpdateHours/',postdata,function(response){
