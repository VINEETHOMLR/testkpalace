                ...
                <div class="widget-content widget-content-area br-6">
                    <div class="row">
                        <div class="row col-md-12 col-xs-12">
                            <form id="userForm" class="row col-md-2" method="post" action="<?=BASEURL;?>Allergies/Index">
                            ...
                            <?php if(  in_array(85, $this->admin_services) ||($this->admin_role==1)) { ?>
                              <div class="form-group col-sm-3">
                                       <a href="<?=BASEURL?>Allergies/Create/"><button class="btn btn-outline-info addbtn mb-2" >
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>Create Allergy</button></a>
                                  </div>
                    ...
                    <div  class="table-responsive mb-4 mt-4" style="overflow-x: scroll !important;">
                        <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                          ...
                          <div class="row text-center">
                            <form class="col-md-12" id="user_pagination" method="post" action="<?=BASEURL;?>Allergies/Index">
            ...
            swal({
                 ...
                 padding: '2em'
                    ...
                    if (result.value) {
                      ...
                      $.post('<?=BASEURL;?>Allergies/ChangeStatus',{'id':id,'status':changedToStatus},function(response){
                            hideoverlay();
