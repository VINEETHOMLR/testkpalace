            ...
            <div class="col-12">
                <div class="card">
                    <nav class="breadcrumb-two" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=BASEURL;?>Allergies/Index/">Allergy list</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Allergy</a></li>
                        </ol>
                    </nav>
                    <div class="card-body">
                        <div class="row" >
...
function save()
{
    ...
    $.ajax({
              ...
              success: function(response){ 
                  ...
                  {
                      openSuccess(newResp['response'],'<?=BASEURL;?>Allergies/Index/')  
                  }else
                  {
