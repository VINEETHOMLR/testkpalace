            ...
            <div class="col-12">
                <div class="card">
                    <nav class="breadcrumb-two" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=BASEURL;?>Room/Index/">Room list</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Room/Table</a></li>
                        </ol>
                    </nav>
                    <div class="card-body">
                        <div class="row" >
                                ...
                                <div class="step-1-user">
                                    <div class="panel-body row">
                                        <div class="col-md-8 col-sm-12 statbox widget box box-shadow">
                                            ...
                                            <div class="form-group col-sm-12 col-md-12">
                                               ...
                                               <select id="test_type" name="type" class="form-control custom-select roleSel">
                                            ...
                                            <div class="tabcontent form-group col-sm-12 col-md-12">
                                                <input type="text" id="table_no" name="table_no" class="form-control" placeholder="Enter Table Number" value ="">
                                            </div>
                                           ...
                                           <div class=" content form-group col-sm-12 col-md-12">
                                                <input type="text" id="level" name="level" class="form-control" placeholder="Enter Level" value ="">
                                            </div>
                                            ...
                                            <div class=" content form-group col-sm-12 col-md-12">
                                                <input type="text" id="room_no" name="room_no" class="form-control" placeholder="Enter Room Number" value ="">
                                            </div>
                                            ...
                                            <div class=" form-group col-sm-12 col-md-12">
                                                ...
                                                <textarea class="form-control" id="description" name="description" placeholder="Enter Description Here" spellcheck="false"></textarea>
                                            </div>
                                            <div class="content col-sm-12 col-md-12">
                                                <label>Maximum Allowed<span style="color:red;">*</span></label>
                                            </div>
                                            <div class=" content form-group col-sm-12 col-md-12">
                                                <input type="text" id="maximum_allowed" name="maximum_allowed" class="form-control" placeholder="Enter Maximum Person Allowed " value ="">
                                            </div>
                                            ...
                                            <div class=" content form-group col-sm-12 col-md-12">
                                                <input type="text"  id="price" name="price" class="form-control input-sm" placeholder="Enter Price" value="">
                                            </div>
                                    ...
                                    <div class="content panel-footer">
                                        <div class="form-actions text-center">
                                            <button type="button" class="btn btn-info proceedToNext col-12 col-md-3">&nbsp;Add Room</button>
                                        </div>
                                    </div>

                                    <div class="tabcontent panel-footer">
                                        <div class="form-actions text-center">
                                            <button type="button" class="btn btn-info proceedToNext col-12 col-md-3">&nbsp;Add Table</button>
                                        </div>
                                    </div>
                                </div>
...
$(function () {
    $('.proceedToNext').click(function(){
        postdata = $('#regiseterNewUser').serializeArray();
         ...
         $.post('<?=BASEURL;?>Room/Addnewroom/',postdata,function(response){
