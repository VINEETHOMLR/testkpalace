            ...
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                  <nav class="breadcrumb-two" aria-label="breadcrumb">
                      <ol class="breadcrumb">
                          <li class="breadcrumb-item"><a href="<?=BASEURL;?>Leave/">Leave Settings List</a></li>
                                    ...
                                    <div class="col-md-11 mt-4 mb-4">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 form-group">
                                                ...
                                                <input type="text" name="name" id="name" value="<?php if(!empty($leave_name)){echo htmlspecialchars_decode($leave_name);}?>" class="form-control" placeholder="Enter Leave Name">                                 
                                            </div>
                                            <div class="col-12 col-md-6 form-group">
                                                <label>Maximum Leave (In Days)</label>
                                                <input type="text" name="allowed_count" id="allowed_count" value="<?php if(!empty($allowed_count)){echo htmlspecialchars_decode($allowed_count);}?>" class="form-control" placeholder="Enter Leave Count">                                 
                                            </div>
